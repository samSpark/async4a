 ...
 *
 * <p>A state is a <code>AsyncState</code> object and must implement
 ...
 * which initializes and starts the state machine. The first action the AsyncStateMachine
 ...
 *
 * <p>In addition to <code>processMessage</code> each <code>AsyncState</code> has
 ...
 * <code>
 * class HelloWorld extends AsyncStateMachine {
 ...
 * }
 * <p>
 * class State1 extends AsyncState {
 ...
 * <code>
 * class Hsm1 extends AsyncStateMachine {
...
public class AsyncStateMachine {
    ...
    /**
     * Constructor creates a AsyncStateMachine with its own thread.
     *
     * @param name of the state machine
     */
    protected AsyncStateMachine(String name) {
    ...
    /**
     * Constructor creates a AsyncStateMachine using the looper.
     *
     * @param name of the state machine
     */
    protected AsyncStateMachine(String name, Looper looper) {
        initStateMachine(name, looper);
    }

    /**
     * Constructor creates a AsyncStateMachine using the handler.
     *
     * @param name of the state machine
     */
    protected AsyncStateMachine(String name, Handler handler) {
     ...
     */
    protected final void addState(AsyncState state, AsyncState parent) {
     ...
     * @param state to add
     */
    protected final void addState(AsyncState state) {
     ...
     */
    protected final void setInitialState(AsyncState initialState) {
     ...
     * {@link AsyncStateMachine#haltedProcessMessage(Message)}
     */
     ...
     * the derived AsyncStateMachine. The AsyncStateMachine will stop and any subsequent messages will be
     * ignored. In addition, if this AsyncStateMachine created the thread, the thread will
     ...
     * AsyncStateMachine#sendMessage the message will just be ignored.
     *
     ...
     * Protected, may only be called by instances of AsyncStateMachine.
     * <p>
     * Message is ignored if state machine has quit.
     */
     ...
     * {@link AsyncStateMachine#quit} or {@link AsyncStateMachine#quitNow}.
     */
    ...
    /**
     * AsyncStateMachine logging record.
     * {@hide}
     */
    public static class LogRec {
        private AsyncStateMachine mSm;
        private long mTime;
        private int mWhat;
         ...
         *                     processed.
         */
        LogRec(AsyncStateMachine sm, Message msg, String info, State state, State orgState,
               State transToState) {
         ...
         */
        public void update(AsyncStateMachine sm, Message msg, String info, State state, State orgState,
                           State dstState) {
            mSm = sm;
    ...
    private static class LogRecords {
        ...
        private final Vector<LogRec> mLogRecVector = new Vector<LogRec>();
         ...
         *                     processed.
         */
        synchronized void add(AsyncStateMachine sm, Message msg, String messageInfo, State state,
    ...
    private static class SmHandler extends Handler {
        ...
        /**
         * AsyncState used when state machine is halted
         */
        private final HaltingState mHaltingState = new HaltingState();
        /**
         * AsyncState used when state machine is quitting
         */
        private final QuittingState mQuittingState = new QuittingState();
        /**
         * The map of all of the states in the state machine
         */
        private final HashMap<AsyncState, StateInfo> mStateInfo = new HashMap<AsyncState, StateInfo>();
        /**
         * The list of deferred messages
         */
        private final ArrayList<Message> mDeferredMessages = new ArrayList<Message>();
        /**
         * true if AsyncStateMachine has quit
         */
        ...
        /**
         * Reference to the AsyncStateMachine
         */
        private AsyncStateMachine mSm;
        /**
         * The initial state that will process the first message
         */
        private AsyncState mInitialState;
        /**
         * The destination state when transitionTo has been invoked
         */
        private AsyncState mDestState;
         ...
         */
        private SmHandler(Looper looper, AsyncStateMachine sm) {
            super(looper);
            mSm = sm;
        ...
        public final void handleMessage(Message msg) {
            if (!mHasQuit) {
                ...
                /** AsyncState that processed the message */
                AsyncState msgProcessedState = null;
                if (mIsConstructionCompleted) {
                    ...
                    throw new RuntimeException("AsyncStateMachine.handleMessage: "
         ...
         */
        private void performTransitions(AsyncState msgProcessedState, Message msg) {
            /**
             * If transitionTo has been called, exit and then enter
             * the appropriate states. We loop on this to allow
             * enter and exit methods to use transitionTo.
             */
            AsyncState orgState = mStateStack[mStateStackTopIndex].state;
            ...
            AsyncState destState = mDestState;
            if (destState != null) {
                /**
         ...
         */
        private final AsyncState processMsg(Message msg) {
        ...
        private final void invokeExitMethods(StateInfo commonStateInfo) {
            while ((mStateStackTopIndex >= 0)
                ...
                AsyncState curState = mStateStack[mStateStackTopIndex].state;
         ...
         */
        private final StateInfo setupTempStateStackWithStatesToEnter(AsyncState destState) {
            /**
         ...
         */
        private final StateInfo addState(AsyncState state, AsyncState parent) {
            if (mDbg) {
        ...
        /**
         * @see AsyncStateMachine#setInitialState(AsyncState)
         */
        private final void setInitialState(AsyncState initialState) {
            if (mDbg) mSm.log("setInitialState: initialState=" + initialState.getName());
            mInitialState = initialState;
        }

        /**
         * @see AsyncStateMachine#transitionTo(State)
         */
        private final void transitionTo(State destState) {
            mDestState = (AsyncState) destState;
            if (mDbg) mSm.log("transitionTo: destState=" + mDestState.getName());
        }

        /**
         * @see AsyncStateMachine#deferMessage(Message)
         */
        ...
        /**
         * @see AsyncStateMachine#setDbg(boolean)
         */
        ...
        /**
         * AsyncState entered when transitionToHaltingState is called.
         */
        private class HaltingState extends AsyncState {
            @Override
        ...
        /**
         * AsyncState entered when a valid quit message is handled.
         */
        private class QuittingState extends AsyncState {
            @Override
            public boolean processMessage(Message msg) {
                return NOT_HANDLED;
            }
